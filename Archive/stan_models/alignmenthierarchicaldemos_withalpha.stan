...
parameters {
  ...
  real ppvt_parent_alpha_slope;
  real ppvt_child_alpha_slope;
...
model {
  ...
  for (Observation in 1:NumObservations){
    ppvt_vals[Observation] ~ normal(ppvt_intercept + 
      ...
      (alpha_speaker[parentid[Observation]] * age_years[Observation]  * ppvt_parent_alpha_slope)+
      (alpha_speaker[childid[Observation]] * age_years[Observation]  * ppvt_child_alpha_slope)+
