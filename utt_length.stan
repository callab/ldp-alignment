...
model {
 ...
 for (n in 1:numLengths) {
  ...
  utt_length[n] ~ neg_binomial_2(fmax(mu_p_s[utt_parent[n]] + alpha_mean_p_s[utt_parent[n]] * utt_session[n],0.1), fmax(over_p_s[utt_parent[n]] + alpha_over_p_s[utt_parent[n]] * utt_session[n], 0.1));
